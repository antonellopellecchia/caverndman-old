...
[^2]: The notation $$A\angle\alpha$$ I'm adopting here is (a slightly modified version of) the so-called *phasor angle notation* and is mainly used in electrical engineering to manipulate sinusoidal time-dependent physical quantities of the form $$ A e^{i\omega+\phi} = A\angle\phi $$ as complex numbers; here I will use it just as a brief way to write numbers in polar form, before I can use the exponential notation.